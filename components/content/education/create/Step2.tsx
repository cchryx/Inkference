...
const DateRangePicker = ({ onChange, initialValue }: Props) => {
    ...
    useEffect(() => {
        ...
        onChange({
            startDate: startValid
                ...
                : null,
            endDate: endValid ? toUnix(endYear, endMonth, endDay) : null,
        });
        ...
        <div className="space-y-6">
            ...
            <div>
                <div className="flex items-center gap-2">
                    ...
                    <InfoTooltip text="When did this education begin? Or when do you expect to start this education." />
                </div>
            ...
            <div>
                <div className="flex items-center gap-2">
                    ...
                    <InfoTooltip text="When did this education end? Or when do you expect to graduate." />
                </div>
                <div className="flex gap-2 mt-1">
                    {renderDropdown(
                        "Year",
